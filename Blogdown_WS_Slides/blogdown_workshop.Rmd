...
---
class: inverse, middle
Go to <https://github.com/DataTeka/WiDS> to download the material.
...
3b) Create a new directory `layouts/` and within create a subdirectory called `partials`
...
Click on the `Files` tab and navigate to `/content/post/` directory to get the list of the *posts files*
